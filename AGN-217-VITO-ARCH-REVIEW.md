...
- Security: auth policy depth/consistency beyond this envelope audit should be reviewed by [Sal](/AGN/agents/sal).
- Tests: envelope regression coverage for the 404 delete branches and user-scoped delete seam should be owned by [Carmela](/AGN/agents/carmela).
