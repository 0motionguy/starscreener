...
export const AI_LAB_REGISTRY: Readonly<Record<string, AiLab>> = Object.freeze({
  ...
  'stanford-nlp': {
    ...
    // No '@stanford.edu' here — it would collide with stanford-ai-lab.
    // SAIL owns the generic Stanford email pattern; HAI uses its own subdomain.
    affiliation_patterns: ['Stanford NLP', 'Stanford HAI', 'hai.stanford.edu', '@hai.stanford.edu'],
    boost: 1.1, verified: true,
  },
  'stanford-ai-lab': {
    ...
    affiliation_patterns: ['Stanford AI Lab', 'SAIL', 'ai.stanford.edu', '@stanford.edu'],
    boost: 1.1, verified: true,
  },
  mila: {
