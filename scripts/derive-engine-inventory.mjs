...
const json = { workflows, cron_routes: cronRoutes, worker_fetchers: workerFetchers, env_vars: envVars };
writeFileSync(join(OUT_DIR, "engine.json"), JSON.stringify(json, null, 2) + "\n", "utf8");

const lines = [];
lines.push(`# Engine inventory - auto-generated by scripts/derive-engine-inventory.mjs (deterministic - re-run any time)`);
lines.push("");
