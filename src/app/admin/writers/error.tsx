...
export default function AdminWritersError({ error, reset }: ErrorProps) {
  useEffect(() => {
  ...
  return (
    <div className="max-w-[640px] mx-auto px-4 md:px-6 py-16 md:py-24 text-center">
      ...
      >
        Writer-provenance lookup failed. Likely Redis brownout or a
        per-key parse error. Reload to retry.
      </p>
      {error.digest && (
        <p
