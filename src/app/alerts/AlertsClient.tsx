      ...
      <ProfileTemplate
        ...
        identity={
          ...
          >
            ...
            {/* Anonymous-only surface post Wave-7 unification: signed-in
                users are server-redirected to /you/alerts before this
                renders. Explain what the account surface adds. */}
            <p
              style={{
                marginTop: 4,
                marginBottom: 0,
