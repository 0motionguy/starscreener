...
export async function generateMetadata({ params }: PageProps) {
  ...
  const description = `The best open-source alternatives to ${full}, ranked by cross-source momentum across GitHub, Hacker News, Reddit, X, Bluesky and Dev.to. Updated continuously.`;
