...
export async function generateMetadata({ params }: PageProps) {
  ...
  const description = clampDescription(
    `${meta.description}. The top trending open-source ${meta.name} repos right now, ranked by cross-source momentum across GitHub, Hacker News, X, Bluesky, Product Hunt and Dev.to. Updated continuously.`,
  );
