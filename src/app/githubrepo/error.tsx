...
export default function GithubRepoError({ error, reset }: ErrorProps) {
  useEffect(() => {
  ...
  return (
    <div className="max-w-[640px] mx-auto px-4 md:px-6 py-16 md:py-24 text-center">
      ...
      >
        The trending GitHub repos surface failed to render. Try again, or head
        home if it keeps erroring.
      </p>
      {error.digest && (
        <p
