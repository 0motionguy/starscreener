...
// to Slack/iMessage; only the canvas height differs. We render a dedicated
...
export const alt = "TrendingRepo — Repo research brief";
...
export default async function RepoTwitterImage({ params }: RouteParams) {
  ...
  const sparkPath = hasSparkline
    ? buildSparklinePath(spark, 1056, 80)
    : null;
      ...
      >
        ...
        >
          <BigStat
            ...
            color={OG_COLORS.textPrimary}
            icon={<StarMark size={24} color={OG_COLORS.brand} />}
          />
          <BigStat label="24h" value={deltaLabel} color={deltaColor} />
          <BigStat
            label="Momentum"
