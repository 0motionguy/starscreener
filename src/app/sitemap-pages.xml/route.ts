...
const STATIC_HUBS: StaticHub[] = [
  ...
  { path: "/top", priority: 0.85, changefreq: "hourly" },
  { path: "/mindshare", priority: 0.8, changefreq: "hourly" },
  { path: "/predict", priority: 0.8, changefreq: "daily" },
  { path: "/tierlist", priority: 0.8, changefreq: "daily" },
  { path: "/digest", priority: 0.8, changefreq: "daily" },
  { path: "/ideas", priority: 0.75, changefreq: "daily" },
  { path: "/agent-repos", priority: 0.75, changefreq: "daily" },
  { path: "/agent-commerce", priority: 0.7, changefreq: "daily" },
  { path: "/huggingface", priority: 0.75, changefreq: "daily" },
  { path: "/huggingface/models", priority: 0.75, changefreq: "daily" },
  { path: "/githubrepo", priority: 0.7, changefreq: "daily" },
  { path: "/skills", priority: 0.7, changefreq: "weekly" },
  { path: "/mcp", priority: 0.7, changefreq: "weekly" },
  { path: "/tools", priority: 0.7, changefreq: "weekly" },
  { path: "/tools/star-history", priority: 0.65, changefreq: "weekly" },
  { path: "/tools/treemap", priority: 0.65, changefreq: "weekly" },
  { path: "/tools/revenue-estimate", priority: 0.65, changefreq: "weekly" },
  { path: "/research", priority: 0.65, changefreq: "weekly" },
  { path: "/alerts", priority: 0.5, changefreq: "weekly" },
  { path: "/portal/docs", priority: 0.5, changefreq: "weekly" },
