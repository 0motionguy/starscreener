import { getAisoUserPrefsDisplay } from "@/lib/aiso-user-prefs";

import { AccountAisoSettings } from "./AccountAisoSettings";
...
export async function AccountSettingsPanel({
  ...
  const aisoPrefs = await getAisoUserPrefsDisplay();
  ...
  return (
    <div className="col gap-4">
      ...
      <AccountAisoSettings initial={aisoPrefs} />
    </div>
  );
}
