...
const ROUTES: CronRouteCase[] = [
  ...
  { name: "sources-auto-recover", path: "/api/cron/sources-auto-recover", method: "POST", modulePath: "@/app/api/cron/sources-auto-recover/route" },
  ...
  { name: "subdomain-takeover", path: "/api/cron/subdomain-takeover", method: "POST", modulePath: "@/app/api/cron/subdomain-takeover/route" },
