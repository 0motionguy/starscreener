...
const ROUTES: CronRouteCase[] = [
  ...
  { name: "llm-sync-models", path: "/api/cron/llm/sync-models", method: "GET", modulePath: "@/app/api/cron/llm/sync-models/route" },  { name: "twitter-daily", path: "/api/cron/twitter-daily", method: "POST", modulePath: "@/app/api/cron/twitter-daily/route" },
